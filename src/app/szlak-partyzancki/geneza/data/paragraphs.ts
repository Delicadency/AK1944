export const paragraphs = [
    ...
    content: [
      {
        ...
        points: [
          ...
          "pozyskanie partnerów: w Księdze Mądrości Syracha napisano: „Wierny przyjaciel potężną obroną, kto go znalazł, skarb znalazł”. Przy realizacji pomysłu Szlaku udało się spokać wielu życzliwych ludzi, którzy wsparli tą ideę cenną radą, pomocą merytoryczną oraz finansową.",
        ],
      },
      {
        text: "Główni mecenasi projektu to:",
        points: [
          ...
          "organizacja kombatancka Środowisko 5. Pułku Strzelców Konnych AK Światowego Związku Żołnierzy AK w Dębicy (nieocenione rady ze strony mjra Mariana Więcka, Andrzeja Strumskiego, Tadeusza Kubicy i in.)",
  ...
  },
  {
    ...
    content: [
      ...
      {
        text: "Wszelkiego rodzaju  wcześniejsze,  kontunuowane lub przyszłe inicjatywy powinny być zbieżne z podstawowymi celami jakie założono przy tworzeniu Szlaku. Priorytetem wynikającym z podjętej misji była i jest troska o historię, tradycję i dziedzictwo Armii Krajowej oraz upamiętnienie miejsc historycznych związanych z działalnością AK w powiecie dębickim.",
      },
      {
      ...
      {
        text: "Szeroko pojęta promocja produktu, wiąże się zatem z realizacją tych celów. Do głównych działań związanych z popularyzacją projektu, należą:",
        points: [
