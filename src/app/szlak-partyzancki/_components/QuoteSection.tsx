...
export const QuoteSection = ({
  ...
  return (
    <section className="relative h-fit max-w-[620px] rounded-md bg-greenLight px-3 py-8 text-greenMain contrast:bg-yellowContrast contrast:text-black00 desktop:px-14">
