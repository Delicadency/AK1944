...
export const QuoteSection = ({
  ...
  return (
    <section className={clsx("relative h-fit max-w-[620px] rounded-md bg-greenLight px-3 py-8 text-greenMain contrast:bg-yellowContrast contrast:text-black00 desktop:px-14", className)}>
      <QuotationIcon className="mb-5 shrink-0 text-greenMain contrast:text-black00 desktop:absolute desktop:-left-2 desktop:mb-0" />
